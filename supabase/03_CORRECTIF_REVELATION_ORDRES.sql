...
begin
  ...
  with ib as (
    ...
    select o.campaign_id, o.turn_id, o.id, t.id, o.campaign_player_id, t.owner_campaign_player_id, v_turn.army_base_points, case when t.type = 'fort' then 'Forteresse : défenseur +200 points d''armée.' when t.is_fortified then 'Fortification : défenseur +200 points d''armée.' else null end
